...
#setenv
eb setenv PORT=$PORT POSTGRES_HOST=$POSTGRES_HOST POSTGRES_PORT=$POSTGRES_PORT POSTGRES_USERNAME=$POSTGRES_USERNAME POSTGRES_PASSWORD=$POSTGRES_PASSWORD POSTGRES_DB=$POSTGRES_DB AWS_ACCESS_KEY_ID=$AWS_ACCESS_KEY_ID AWS_DEFAULT_REGION=$AWS_DEFAULT_REGION AWS_SECRET_ACCESS_KEY=$AWS_SECRET_ACCESS_KEY JWT_SECRET=$JWT_SECRET S3_AWS_BUCKET_S3=$S3_AWS_BUCKET_S3 S3_AWS_PROFILE_S3=S3_AWS_PROFILE_S3 S3_AWS_REGION_S3=$S3_AWS_REGION_S3
